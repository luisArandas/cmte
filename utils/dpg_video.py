...
# fork of https://github.com/Pcothren/DearPyGui-Examples/blob/main/camera_capture_with_opencv.py
...
vid = cv.VideoCapture(r"C:\Users\Luis Arandas\Desktop\media\testvid2.mp4")
ret, frame = vid.read()
